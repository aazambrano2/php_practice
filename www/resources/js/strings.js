...
document.write(phrase.charAt(3),'<br>');
//if there are duplicates, the first occuernce index will be returned. Else -1 if no char exist.
document.write(phrase.indexOf("i"),'<br>'); 
...
document.write(phrase + "YES! " + text,'<br>');
//Source: https://www.w3schools.com/jsref/jsref_obj_string.asp