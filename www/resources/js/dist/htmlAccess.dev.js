...
header.innerHTML = "This is Aaron's Website. Welcome!"; //javascript.html.css 
...
function video() {
  //alert("test");
  var video = "https://www.youtube.com/watch?v=YnplRWla99Q&ab_channel=UTEPMiners"; //https://www.utep.edu/ 
  //https://www.youtube.com/watch?v=xUEqDQOjAlA&ab_channel=ALDBARANofficiel

  return video;
}

var image = document.getElementById("image"); //alternative on click event listener
